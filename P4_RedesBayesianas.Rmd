...
plot.network <- function(estructura, ht = "100px"){
...
```{r}
set.seed(1)
cat("P(entrena waterpolo | alto nivel hemoglobina y tiene alta tasa de hematocrito) =", cpquery(bn.mod, (deporte=="W_Polo"), (alto_hg == "TRUE" & alto_hc == "TRUE"), n=100000))
```
